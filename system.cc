...
Optional<Error> System::Start() {
  ...
  RETURN_IF_ERROR(PortError(Pa_OpenDefaultStream(&audio_out_stream_,
                                                 0, 2,
                                                 paFloat32, sample_rate_,
                                                 frames_per_chunk_,
                                                 ::AudioDriverCallback,
                                                 this)));
  ...
  RETURN_IF_ERROR(PortError(Pm_OpenInput(&midi_in_stream_,
...
void System::AudioDriverCallback(const float* in,
                                 float* out,
                                 int frame_count) {
  CHECK(out != nullptr);
